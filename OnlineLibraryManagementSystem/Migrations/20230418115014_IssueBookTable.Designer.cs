...
namespace OnlineLibraryManagementSystem.Migrations
{
    ...
    [Migration("20230418115014_IssueBookTable")]
    partial class IssueBookTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineLibraryManagementSystem.Models.Admin.Book.BookAuthor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineLibraryManagementSystem.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineLibraryManagementSystem.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineLibraryManagementSystem.Models.Admin.Book.Book", b =>
                {
                    b.HasOne("OnlineLibraryManagementSystem.Models.Admin.Book.Author", null)
                        .WithMany("Books")
                        .HasForeignKey("AuthorId");

                    b.HasOne("OnlineLibraryManagementSystem.Models.Admin.Book.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("OnlineLibraryManagementSystem.Models.Admin.Book.BookAuthor", b =>
                {
                    b.HasOne("OnlineLibraryManagementSystem.Models.Admin.Book.Author", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
